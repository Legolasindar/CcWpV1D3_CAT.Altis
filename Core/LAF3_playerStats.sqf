...
if (local player) exitWith {
	...
	LAF3_fnc_pstats = {
		_hText =  parseText format["
			<t color='#2E80C6' size='1.5' align='left'>PLAYER INFO/STATS</t><br/><br/>
	...
	if (_s == "mdev") exitWith {
		...
		_hSquad = "MM/GM";
		_hCallsign = "Control";		
		[_hSquad, _hTeam, _hRole, _hCallsign] call LAF3_fnc_pstats;
	};
	
	if (_s == "opc") exitWith {
		_hTeam = "Operational Command";
		_hSquad = "1st L.A.M.B.S Co";
		_hCallsign = "Gandalf";
